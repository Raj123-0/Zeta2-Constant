...
Calculates Zeta2 Constant to an arbitrary precision of [N] significant digits using a highly optimized 12-core parallelized algorithm.
...
```bash
python "Zeta2 Constant.py" -n 1000
```
